...
1. Recommended Architecture: The best-practice stack balancing performance, cost, and developer productivity.
2. Cost-Optimized Architecture: A stack designed to minimize monthly operations costs, perhaps utilizing serverless scale-to-zero configurations or database sharing.
3. Bleeding-Edge Architecture: A modern, highly scalable stack using cutting-edge frameworks, databases (e.g. Elixir/Phoenix, Rust, WASM, ScyllaDB) which are powerful but have higher complexity.
...
interface ArchitectureOption {
  ...
  name: string; // Title of the stack, prefix with: "Recommended: ...", "Cost-Optimized: ...", "Bleeding-Edge: ..."
