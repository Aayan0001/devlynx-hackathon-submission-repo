    ...
    <div className="min-h-screen relative overflow-hidden flex flex-col justify-between">
      ...
      <header className="w-full max-w-7xl mx-auto px-6 py-6 flex justify-between items-center z-10">
        <div className="flex items-center gap-3">
          <div className="p-2.5 bg-gradient-to-tr from-accent to-[#818cf8] rounded-xl shadow-glow-accent">
            <Cpu className="w-6 h-6 text-white" />
          </div>
          <span className="font-extrabold text-2xl tracking-wider bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">
      ...
      <main className="flex-grow flex flex-col items-center justify-center text-center px-6 max-w-5xl mx-auto py-12 z-10">
        ...
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent/10 border border-accent/20 text-accent text-xs font-semibold uppercase tracking-wider mb-6 animate-pulse">
          <Zap className="w-3.5 h-3.5" /> Next-Generation Architectural Copilot
        </div>
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight text-white mb-6 leading-[1.1]">
          ...
          With <span className="bg-gradient-to-r from-accent via-indigo-400 to-emerald-400 bg-clip-text text-transparent">Agentic Intelligence</span>
        </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl">
          <div className="glass-panel glass-panel-hover p-6 rounded-2xl text-left">
            ...
            <h3 className="font-bold text-white text-lg mb-2">6-Stage Agent Pipeline</h3>
          ...
          <div className="glass-panel glass-panel-hover p-6 rounded-2xl text-left">
            ...
            <h3 className="font-bold text-white text-lg mb-2">Sourced Exa AI Research</h3>
            <p className="text-sm text-gray-400 font-light leading-relaxed">
          ...
          <div className="glass-panel glass-panel-hover p-6 rounded-2xl text-left">
            ...
            <h3 className="font-bold text-white text-lg mb-2">Interactive Scaling Playgrounds</h3>
            <p className="text-sm text-gray-400 font-light leading-relaxed">
        ...
        <div className="mt-24 w-full">
          <h2 className="text-2xl font-bold text-white mb-10 flex items-center justify-center gap-3">
      ...
      {/* Footer */}
      <footer className="w-full py-8 text-center text-xs text-gray-600 border-t border-white/5 z-10 bg-[#07080c]">
        TechStack AI &copy; 2026. Made for engineers, startup founders, and architectural decision compliance.
      </footer>

      {/* Background glow animations */}
      <div className="absolute top-[20%] left-[10%] w-[350px] h-[350px] rounded-full bg-accent/10 filter blur-[80px] -z-10 animate-pulse"></div>
      <div className="absolute bottom-[20%] right-[10%] w-[400px] h-[400px] rounded-full bg-emerald-500/5 filter blur-[100px] -z-10"></div>
    </div>
  );
}
